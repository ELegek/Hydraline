(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main__slider")) new core(".main__slider", {
            ...
            pagination: {
                el: ".main__control-dotts",
                clickable: true
            },
            navigation: {
                prevEl: ".main__control-arrow-prev",
                nextEl: ".main__control-arrow-next"
            },
            on: {}
        });
        if (document.querySelector(".partners-block__slider")) new core(".partners-block__slider", {
